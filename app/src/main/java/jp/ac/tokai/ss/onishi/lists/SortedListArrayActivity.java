...
public class SortedListArrayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v != null) {
            ...
            if (v == bsearch) {
                String str = intext.getText().toString();
                if (!str.equals("")) {
                    int found = listArray.binarySearch(str);
                    String msg;
